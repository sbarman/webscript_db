...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Benchmark.enabled'
        db.add_column('webscript_backend_benchmark', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Benchmark.enabled'
        db.delete_column('webscript_backend_benchmark', 'enabled')
