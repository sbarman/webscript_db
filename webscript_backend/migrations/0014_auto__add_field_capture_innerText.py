...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Capture.innerText'
        db.add_column('webscript_backend_capture', 'innerText',
                      self.gf('django.db.models.fields.TextField')(default=' '),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Capture.innerText'
        db.delete_column('webscript_backend_capture', 'innerText')
