...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BenchmarkRun.log'
        db.add_column('webscript_backend_benchmarkrun', 'log',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BenchmarkRun.log'
        db.delete_column('webscript_backend_benchmarkrun', 'log')
