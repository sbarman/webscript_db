...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Benchmark.success_condition'
        db.delete_column('webscript_backend_benchmark', 'success_condition')

        # Adding field 'Benchmark.success_captures'
        db.add_column('webscript_backend_benchmark', 'success_captures',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'BenchmarkRun.events_total'
        db.add_column('webscript_backend_benchmarkrun', 'events_total',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'BenchmarkRun.notes'
        db.add_column('webscript_backend_benchmarkrun', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Benchmark.success_condition'
        db.add_column('webscript_backend_benchmark', 'success_condition',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Benchmark.success_captures'
        db.delete_column('webscript_backend_benchmark', 'success_captures')

        # Deleting field 'BenchmarkRun.events_total'
        db.delete_column('webscript_backend_benchmarkrun', 'events_total')

        # Deleting field 'BenchmarkRun.notes'
        db.delete_column('webscript_backend_benchmarkrun', 'notes')
    ...
    models = {
        ...
        'webscript_backend.capture': {
            ...
            'innerText': ('django.db.models.fields.TextField', [], {}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
