...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Benchmark.creation_date'
        db.add_column('webscript_backend_benchmark', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 6, 25, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Benchmark.modification_date'
        db.add_column('webscript_backend_benchmark', 'modification_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2015, 6, 25, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'BenchmarkRun.trigger_timeouts'
        db.add_column('webscript_backend_benchmarkrun', 'trigger_timeouts',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BenchmarkRun.element_timeouts'
        db.add_column('webscript_backend_benchmarkrun', 'element_timeouts',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BenchmarkRun.version'
        db.add_column('webscript_backend_benchmarkrun', 'version',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Benchmark.creation_date'
        db.delete_column('webscript_backend_benchmark', 'creation_date')

        # Deleting field 'Benchmark.modification_date'
        db.delete_column('webscript_backend_benchmark', 'modification_date')

        # Deleting field 'BenchmarkRun.trigger_timeouts'
        db.delete_column('webscript_backend_benchmarkrun', 'trigger_timeouts')

        # Deleting field 'BenchmarkRun.element_timeouts'
        db.delete_column('webscript_backend_benchmarkrun', 'element_timeouts')

        # Deleting field 'BenchmarkRun.version'
        db.delete_column('webscript_backend_benchmarkrun', 'version')
    ...
    models = {
        ...
        'webscript_backend.benchmarkrun': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'element_timeouts': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'trigger_timeouts': ('django.db.models.fields.IntegerField', [], {}),
