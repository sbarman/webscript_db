...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Capture.html'
        db.delete_column('webscript_backend_capture', 'html')

        # Adding field 'Capture.innerHtml'
        db.add_column('webscript_backend_capture', 'innerHtml',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Capture.nodeName'
        db.add_column('webscript_backend_capture', 'nodeName',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Capture.html'
        db.add_column('webscript_backend_capture', 'html',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'Capture.innerHtml'
        db.delete_column('webscript_backend_capture', 'innerHtml')

        # Deleting field 'Capture.nodeName'
        db.delete_column('webscript_backend_capture', 'nodeName')
