...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.script'
        db.alter_column('webscript_backend_comment', 'script_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['webscript_backend.Script']))

        # Changing field 'Parameter.event'
        db.alter_column('webscript_backend_parameter', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['webscript_backend.Event']))

        # Changing field 'Script.description'
        db.alter_column('webscript_backend_script', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Script.notes'
        db.alter_column('webscript_backend_script', 'notes', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'Comment.script'
        db.alter_column('webscript_backend_comment', 'script_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['webscript_backend.Script']))

        # Changing field 'Parameter.event'
        db.alter_column('webscript_backend_parameter', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['webscript_backend.Event']))

        # Changing field 'Script.description'
        db.alter_column('webscript_backend_script', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Script.notes'
        db.alter_column('webscript_backend_script', 'notes', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'webscript_backend.benchmark': {
            ...
            'success_condition': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
