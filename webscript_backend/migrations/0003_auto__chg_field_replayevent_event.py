...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReplayEvent.event'
        db.alter_column('webscript_backend_replayevent', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webscript_backend.Event'], null=True))

    def backwards(self, orm):

        # Changing field 'ReplayEvent.event'
        db.alter_column('webscript_backend_replayevent', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['webscript_backend.Event']))
