...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BenchmarkRun.time'
        db.add_column('webscript_backend_benchmarkrun', 'time',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BenchmarkRun.time'
        db.delete_column('webscript_backend_benchmarkrun', 'time')
