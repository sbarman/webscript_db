...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('webscript_backend_comment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('value', self.gf('django.db.models.fields.TextField')()),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='comments', null=True, blank=True, to=orm['webscript_backend.Event'])),
            ('replay_event', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='comments', null=True, blank=True, to=orm['webscript_backend.ReplayEvent'])),
        ...
        db.send_create_signal('webscript_backend', ['Comment'])


    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table('webscript_backend_comment')
    ...
    models = {
        ...
        'webscript_backend.comment': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'comments'", 'null': 'True', 'blank': 'True', 'to': "orm['webscript_backend.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'replay_event': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'comments'", 'null': 'True', 'blank': 'True', 'to': "orm['webscript_backend.ReplayEvent']"}),
