...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('webscript_backend_benchmark', 'name', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Benchmark.name'
        db.alter_column('webscript_backend_benchmark', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))
