...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Benchmark.name'
        db.add_column('webscript_backend_benchmark', 'name',
                      self.gf('django.db.models.fields.CharField')(default='benchmark', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Benchmark.name'
        db.delete_column('webscript_backend_benchmark', 'name')
