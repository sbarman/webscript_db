...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('webscript_backend_capture')

        # Deleting field 'Event.version'
        db.delete_column('webscript_backend_event', 'version')

        # Adding field 'Script.params'
        db.add_column('webscript_backend_script', 'params',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Script.captures'
        db.add_column('webscript_backend_script', 'captures',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('webscript_backend_scriptparameter', (
            ...
            ('script', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='parameters', null=True, to=orm['webscript_backend.Script'], blank=True)),
        ...
        db.create_table('webscript_backend_capture', (
            ('innerText', self.gf('django.db.models.fields.TextField')()),
            ('nodeName', self.gf('django.db.models.fields.TextField')()),
            ('modification_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('script', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webscript_backend.Script'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('innerHtml', self.gf('django.db.models.fields.TextField')()),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('webscript_backend', ['Capture'])

        # Adding field 'Event.version'
        db.add_column('webscript_backend_event', 'version',
                      self.gf('django.db.models.fields.CharField')(default='1.0', max_length=32),
                      keep_default=False)

        # Deleting field 'Script.params'
        db.delete_column('webscript_backend_script', 'params')

        # Deleting field 'Script.captures'
        db.delete_column('webscript_backend_script', 'captures')
